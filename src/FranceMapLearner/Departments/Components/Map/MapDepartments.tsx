...
import computeMapItemClass from '../../../Shared/Utils/computeMapItemClass';
...
type MapDepartmentsProps = {
    onDepartmentClick: (code: number|string) => void,
    game?: undefined,
};

function MapDepartments({ game, onDepartmentClick }: MapDepartmentsProps) {
    return (
        <svg id="map-departments" version="1.1" width="597.6" height="670.7" viewBox="0 0 597.6 670.7" overflow="visible">

            <g className="region region-11" data-name="Île-de-France" data-insee="11">
                <path
                    data-name="Paris"
                    data-departmentnumber="75"
                    onClick={() => onDepartmentClick(75)}
                    className={computeMapItemClass(game, 75, 'region-11 department department-75 department-paris')}
                ...
                <path
                    ...
                    data-departmentnumber="77"
                    onClick={() => onDepartmentClick(77)}
                    className={computeMapItemClass(game, 77, 'region-11 department department-77 department-seine-et-marne')}
                ...
                <path
                    data-name="Yvelines"
                    data-departmentnumber="78"
                    onClick={() => onDepartmentClick(78)}
                    className={computeMapItemClass(game, 78, 'region-11 department department-78 department-yvelines')}
                ...
                <path
                    data-name="Essonne"
                    data-departmentnumber="91"
                    onClick={() => onDepartmentClick(91)}
                    className={computeMapItemClass(game, 91, 'region-11 department department-91 department-essonne')}
                ...
                <path
                    ...
                    data-departmentnumber="92"
                    onClick={() => onDepartmentClick(92)}
                    className={computeMapItemClass(game, 92, 'region-11 department department-92 department-hauts-de-seine')}
                ...
                <path
                    ...
                    data-departmentnumber="93"
                    onClick={() => onDepartmentClick(93)}
                    className={computeMapItemClass(game, 93, 'region-11 department department-93 department-seine-saint-denis')}
                ...
                <path
                    ...
                    data-departmentnumber="94"
                    onClick={() => onDepartmentClick(94)}
                    className={computeMapItemClass(game, 94, 'region-11 department department-94 department-val-de-marne')}
                ...
                <path
                    ...
                    data-departmentnumber="95"
                    onClick={() => onDepartmentClick(95)}
                    className={computeMapItemClass(game, 95, 'region-11 department department-95 department-val-doise')}
            ...
            <g className="region region-24" data-name="Centre-Val de Loire" data-insee="24">
                <path
                    data-name="Cher"
                    data-departmentnumber="18"
                    onClick={() => onDepartmentClick(18)}
                    className={computeMapItemClass(game, 18, 'region-24 department department-18 department-cher')}
                ...
                <path
                    ...
                    data-departmentnumber="28"
                    onClick={() => onDepartmentClick(28)}
                    className={computeMapItemClass(game, 28, 'region-24 department department-28 department-eure-et-loir')}
                ...
                <path
                    data-name="Indre"
                    data-departmentnumber="36"
                    onClick={() => onDepartmentClick(36)}
                    className={computeMapItemClass(game, 36, 'region-24 department department-36 department-indre')}
                ...
                <path
                    ...
                    data-departmentnumber="37"
                    onClick={() => onDepartmentClick(37)}
                    className={computeMapItemClass(game, 37, 'region-24 department department-37 department-indre-et-loire')}
                ...
                <path
                    ...
                    data-departmentnumber="41"
                    onClick={() => onDepartmentClick(41)}
                    className={computeMapItemClass(game, 41, 'region-24 department department-41 department-loir-et-cher')}
                ...
                <path
                    data-name="Loiret"
                    data-departmentnumber="45"
                    onClick={() => onDepartmentClick(45)}
                    className={computeMapItemClass(game, 45, 'region-24 department department-45 department-loiret')}
            ...
            <g className="region region-27" data-name="Bourgogne-Franche-Comté" data-insee="27">
                <path
                    data-name="Côte-d’Or"
                    data-departmentnumber="21"
                    onClick={() => onDepartmentClick(21)}
                    className={computeMapItemClass(game, 21, 'region-27 department department-21 department-cote-dor')}
                ...
                <path
                    data-name="Doubs"
                    data-departmentnumber="25"
                    onClick={() => onDepartmentClick(25)}
                    className={computeMapItemClass(game, 25, 'region-27 department department-25 department-doubs')}
                ...
                <path
                    data-name="Jura"
                    data-departmentnumber="39"
                    onClick={() => onDepartmentClick(39)}
                    className={computeMapItemClass(game, 39, 'region-27 department department-39 department-jura')}
                ...
                <path
                    data-name="Nièvre"
                    data-departmentnumber="58"
                    onClick={() => onDepartmentClick(58)}
                    className={computeMapItemClass(game, 58, 'region-27 department department-58 department-nievre')}
                ...
                <path
                    ...
                    data-departmentnumber="70"
                    onClick={() => onDepartmentClick(70)}
                    className={computeMapItemClass(game, 70, 'region-27 department department-70 department-haute-saone')}
                ...
                <path
                    ...
                    data-departmentnumber="71"
                    onClick={() => onDepartmentClick(71)}
                    className={computeMapItemClass(game, 71, 'region-27 department department-71 department-saone-et-loire')}
                ...
                <path
                    data-name="Yonne"
                    data-departmentnumber="89"
                    onClick={() => onDepartmentClick(89)}
                    className={computeMapItemClass(game, 89, 'region-27 department department-89 department-yonne')}
                ...
                <path
                    ...
                    data-departmentnumber="90"
                    onClick={() => onDepartmentClick(90)}
                    className={computeMapItemClass(game, 90, 'region-27 department department-90 department-territoire-de-belfort')}
            ...
            <g className="region region-28" data-name="Normandie" data-insee="28">
                <path
                    data-name="Calvados"
                    data-departmentnumber="14"
                    onClick={() => onDepartmentClick(14)}
                    className={computeMapItemClass(game, 14, 'region-28 department department-14 department-calvados')}
                ...
                <path
                    data-name="Eure"
                    data-departmentnumber="27"
                    onClick={() => onDepartmentClick(27)}
                    className={computeMapItemClass(game, 27, 'region-28 department department-27 department-eure')}
                ...
                <path
                    data-name="Manche"
                    data-departmentnumber="50"
                    onClick={() => onDepartmentClick(50)}
                    className={computeMapItemClass(game, 50, 'region-28 department department-50 department-manche')}
                ...
                <path
                    data-name="Orne"
                    data-departmentnumber="61"
                    onClick={() => onDepartmentClick(61)}
                    className={computeMapItemClass(game, 61, 'region-28 department department-61 department-orne')}
                ...
                <path
                    ...
                    data-departmentnumber="76"
                    onClick={() => onDepartmentClick(76)}
                    className={computeMapItemClass(game, 76, 'region-28 department department-76 department-seine-maritime')}
            ...
            <g className="region region-32" data-name="Hauts-de-France" data-insee="32">
                <path
                    data-name="Aisne"
                    data-departmentnumber="02"
                    onClick={() => onDepartmentClick(2)}
                    className={computeMapItemClass(game, 2, 'region-32 department department-02 department-aisne')}
                ...
                <path
                    data-name="Nord"
                    data-departmentnumber="59"
                    onClick={() => onDepartmentClick(59)}
                    className={computeMapItemClass(game, 59, 'region-32 department department-59 department-nord')}
                ...
                <path
                    data-name="Oise"
                    data-departmentnumber="60"
                    onClick={() => onDepartmentClick(60)}
                    className={computeMapItemClass(game, 60, 'region-32 department department-60 department-oise')}
                ...
                <path
                    ...
                    data-departmentnumber="62"
                    onClick={() => onDepartmentClick(62)}
                    className={computeMapItemClass(game, 62, 'region-32 department department-62 department-pas-de-calais')}
                ...
                <path
                    data-name="Somme"
                    data-departmentnumber="80"
                    onClick={() => onDepartmentClick(80)}
                    className={computeMapItemClass(game, 80, 'region-32 department department-80 department-somme')}
            ...
            <g className="region region-44" data-name="Grand Est" data-insee="44">
                <path
                    data-name="Ardennes"
                    data-departmentnumber="08"
                    onClick={() => onDepartmentClick(8)}
                    className={computeMapItemClass(game, 8, 'region-44 department department-08 department-ardennes')}
                ...
                <path
                    data-name="Aube"
                    data-departmentnumber="10"
                    onClick={() => onDepartmentClick(10)}
                    className={computeMapItemClass(game, 10, 'region-44 department department-10 department-aube')}
                ...
                <path
                    data-name="Marne"
                    data-departmentnumber="51"
                    onClick={() => onDepartmentClick(51)}
                    className={computeMapItemClass(game, 51, 'region-44 department department-51 department-marne')}
                ...
                <path
                    ...
                    data-departmentnumber="52"
                    onClick={() => onDepartmentClick(52)}
                    className={computeMapItemClass(game, 52, 'region-44 department department-52 department-haute-marne')}
                ...
                <path
                    ...
                    data-departmentnumber="54"
                    onClick={() => onDepartmentClick(54)}
                    className={computeMapItemClass(game, 54, 'region-44 department department-54 department-meurthe-et-moselle')}
                ...
                <path
                    data-name="Meuse"
                    data-departmentnumber="55"
                    onClick={() => onDepartmentClick(55)}
                    className={computeMapItemClass(game, 55, 'region-44 department department-55 department-meuse')}
                ...
                <path
                    data-name="Moselle"
                    data-departmentnumber="57"
                    onClick={() => onDepartmentClick(57)}
                    className={computeMapItemClass(game, 57, 'region-44 department department-57 department-moselle')}
                ...
                <path
                    data-name="Bas-Rhin"
                    data-departmentnumber="67"
                    onClick={() => onDepartmentClick(67)}
                    className={computeMapItemClass(game, 67, 'region-44 department department-67 department-bas-rhin')}
                ...
                <path
                    data-name="Haut-Rhin"
                    data-departmentnumber="68"
                    onClick={() => onDepartmentClick(68)}
                    className={computeMapItemClass(game, 68, 'region-44 department department-68 department-haut-rhin')}
                ...
                <path
                    data-name="Vosges"
                    data-departmentnumber="88"
                    onClick={() => onDepartmentClick(88)}
                    className={computeMapItemClass(game, 88, 'region-44 department department-88 department-vosges')}
            ...
            <g className="region region-52" data-name="Pays de la Loire" data-insee="52">
                <path
                    ...
                    data-departmentnumber="44"
                    onClick={() => onDepartmentClick(44)}
                    className={computeMapItemClass(game, 44, 'region-52 department department-44 department-loire-atlantique')}
                ...
                <path
                    ...
                    data-departmentnumber="49"
                    onClick={() => onDepartmentClick(49)}
                    className={computeMapItemClass(game, 49, 'region-52 department department-49 department-maine-et-loire')}
                ...
                <path
                    data-name="Mayenne"
                    data-departmentnumber="53"
                    onClick={() => onDepartmentClick(53)}
                    className={computeMapItemClass(game, 53, 'region-52 department department-53 department-mayenne')}
                ...
                <path
                    data-name="Sarthe"
                    data-departmentnumber="72"
                    onClick={() => onDepartmentClick(72)}
                    className={computeMapItemClass(game, 72, 'region-52 department department-72 department-sarthe')}
                ...
                <path
                    data-name="Vendée"
                    data-departmentnumber="85"
                    onClick={() => onDepartmentClick(85)}
                    className={computeMapItemClass(game, 85, 'region-52 department department-85 department-vendee')}
            ...
            <g className="region region-53" data-name="Bretagne" data-insee="53">
                <path
                    ...
                    data-departmentnumber="22"
                    onClick={() => onDepartmentClick(22)}
                    className={computeMapItemClass(game, 22, 'region-53 department department-22 department-cotes-darmor')}
                ...
                <path
                    data-name="Finistère"
                    data-departmentnumber="29"
                    onClick={() => onDepartmentClick(29)}
                    className={computeMapItemClass(game, 29, 'region-53 department department-29 department-finistere')}
                ...
                <path
                    ...
                    data-departmentnumber="35"
                    onClick={() => onDepartmentClick(35)}
                    className={computeMapItemClass(game, 35, 'region-53 department department-35 department-ille-et-vilaine')}
                ...
                <path
                    data-name="Morbihan"
                    data-departmentnumber="56"
                    onClick={() => onDepartmentClick(56)}
                    className={computeMapItemClass(game, 56, 'region-53 department department-56 department-morbihan')}
            ...
            <g className="region region-75" data-name="Nouvelle-Aquitaine" data-insee="75">
                <path
                    data-name="Charente"
                    data-departmentnumber="16"
                    onClick={() => onDepartmentClick(16)}
                    className={computeMapItemClass(game, 16, 'region-75 department department-16 department-charente')}
                ...
                <path
                    ...
                    data-departmentnumber="17"
                    onClick={() => onDepartmentClick(17)}
                    className={computeMapItemClass(game, 17, 'region-75 department department-17 department-charente-maritime')}
                ...
                <path
                    data-name="Corrèze"
                    data-departmentnumber="19"
                    onClick={() => onDepartmentClick(19)}
                    className={computeMapItemClass(game, 19, 'region-75 department department-19 department-correze')}
                ...
                <path
                    data-name="Creuse"
                    data-departmentnumber="23"
                    onClick={() => onDepartmentClick(23)}
                    className={computeMapItemClass(game, 23, 'region-75 department department-23 department-creuse')}
                ...
                <path
                    data-name="Dordogne"
                    data-departmentnumber="24"
                    onClick={() => onDepartmentClick(24)}
                    className={computeMapItemClass(game, 24, 'region-75 department department-24 department-dordogne')}
                ...
                <path
                    data-name="Gironde"
                    data-departmentnumber="33"
                    onClick={() => onDepartmentClick(33)}
                    className={computeMapItemClass(game, 33, 'region-75 department department-33 department-gironde')}
                ...
                <path
                    data-name="Landes"
                    data-departmentnumber="40"
                    onClick={() => onDepartmentClick(40)}
                    className={computeMapItemClass(game, 40, 'region-75 department department-40 department-landes')}
                ...
                <path
                    ...
                    data-departmentnumber="47"
                    onClick={() => onDepartmentClick(47)}
                    className={computeMapItemClass(game, 47, 'region-75 department department-47 department-lot-et-garonne')}
                ...
                <path
                    ...
                    data-departmentnumber="64"
                    onClick={() => onDepartmentClick(64)}
                    className={computeMapItemClass(game, 64, 'region-75 department department-64 department-pyrenees-atlantiques')}
                ...
                <path
                    ...
                    data-departmentnumber="79"
                    onClick={() => onDepartmentClick(79)}
                    className={computeMapItemClass(game, 79, 'region-75 department department-79 department-deux-sevres')}
                ...
                <path
                    data-name="Vienne"
                    data-departmentnumber="86"
                    onClick={() => onDepartmentClick(86)}
                    className={computeMapItemClass(game, 86, 'region-75 department department-86 department-vienne')}
                ...
                <path
                    ...
                    data-departmentnumber="87"
                    onClick={() => onDepartmentClick(87)}
                    className={computeMapItemClass(game, 87, 'region-75 department department-87 department-haute-vienne')}
            ...
            <g className="region region-76" data-name="Occitanie" data-insee="76">
                <path
                    data-name="Ariège"
                    data-departmentnumber="09"
                    onClick={() => onDepartmentClick(9)}
                    className={computeMapItemClass(game, 9, 'region-76 department department-09 department-ariege')}
                ...
                <path
                    data-name="Aude"
                    data-departmentnumber="11"
                    onClick={() => onDepartmentClick(11)}
                    className={computeMapItemClass(game, 11, 'region-76 department department-11 department-aude')}
                    d="m435.07,504.37l-1.47,1.53l-5.2,9.3l-0.9,3.5 l0.15,9.57l-9.45-5.57l-8.2,5.4l-13.6-1l-2.7,1.4l1.4,6l-8.6,3.9l-4.8-5.6l-3.3,1.2l-3.4-1.5l-0.8-5.7l3.2-0.6l1.2-3l-2.4-2.5 l2.2-2.3l-0.2-3.1l-2.2-5.2l-8.7-3.9l-2.2-5.5l8.4-10l1.4,2.7l5.2-1.8l0.5-0.8l1.8,2.3l6.3,0.9l1.1-3.3l2.8-0.5l12,1.4l-0.5,2.8 l3.5,5l2.5-1.6l1.4,2.9l3.1-0.8l3.8-5.3l1,2.9l13.8,4.7l1.7,2L435.07,504.37z"
                />
                <path
                    data-name="Aveyron"
                    data-departmentnumber="12"
                    onClick={() => onDepartmentClick(12)}
                    className={computeMapItemClass(game, 12, 'region-76 department department-12 department-aveyron')}
                ...
                <path
                    data-name="Gard"
                    data-departmentnumber="30"
                    onClick={() => onDepartmentClick(30)}
                    className={computeMapItemClass(game, 30, 'region-76 department department-30 department-gard')}
                ...
                <path
                    ...
                    data-departmentnumber="31"
                    onClick={() => onDepartmentClick(31)}
                    className={computeMapItemClass(game, 31, 'region-76 department department-31 department-haute-garonne')}
                ...
                <path
                    data-name="Gers"
                    data-departmentnumber="32"
                    onClick={() => onDepartmentClick(32)}
                    className={computeMapItemClass(game, 32, 'region-76 department department-32 department-gers')}
                ...
                <path
                    data-name="Hérault"
                    data-departmentnumber="34"
                    onClick={() => onDepartmentClick(34)}
                    className={computeMapItemClass(game, 34, 'region-76 department department-34 department-herault')}
                ...
                <path
                    data-name="Lot"
                    data-departmentnumber="46"
                    onClick={() => onDepartmentClick(46)}
                    className={computeMapItemClass(game, 46, 'region-76 department department-46 department-lot')}
                ...
                <path
                    data-name="Lozère"
                    data-departmentnumber="48"
                    onClick={() => onDepartmentClick(48)}
                    className={computeMapItemClass(game, 48, 'region-76 department department-48 department-lozere')}
                ...
                <path
                    ...
                    data-departmentnumber="65"
                    onClick={() => onDepartmentClick(65)}
                    className={computeMapItemClass(game, 65, 'region-76 department department-65 department-hautes-pyrenees')}
                ...
                <path
                    ...
                    data-departmentnumber="66"
                    onClick={() => onDepartmentClick(66)}
                    className={computeMapItemClass(game, 66, 'region-76 department department-66 department-pyrenees-orientales')}
                ...
                <path
                    data-name="Tarn"
                    data-departmentnumber="81"
                    onClick={() => onDepartmentClick(81)}
                    className={computeMapItemClass(game, 81, 'region-76 department department-81 department-tarn')}
                ...
                <path
                    ...
                    data-departmentnumber="82"
                    onClick={() => onDepartmentClick(82)}
                    className={computeMapItemClass(game, 82, 'region-76 department department-82 department-tarn-et-garonne')}
            ...
            <g className="region region-84" data-name="Auvergne-Rhône-Alpes" data-insee="84">
                <path
                    data-name="Ain"
                    data-departmentnumber="01"
                    onClick={() => onDepartmentClick(1)}
                    className={computeMapItemClass(game, 1, 'region-84 department department-01 department-ain')}
                ...
                <path
                    data-name="Allier"
                    data-departmentnumber="03"
                    onClick={() => onDepartmentClick(3)}
                    className={computeMapItemClass(game, 3, 'region-84 department department-03 department-allier')}
                ...
                <path
                    data-name="Ardèche"
                    data-departmentnumber="07"
                    onClick={() => onDepartmentClick(7)}
                    className={computeMapItemClass(game, 7, 'region-84 department department-07 department-ardeche')}
                ...
                <path
                    data-name="Cantal"
                    data-departmentnumber="15"
                    onClick={() => onDepartmentClick(15)}
                    className={computeMapItemClass(game, 15, 'region-84 department department-15 department-cantal')}
                ...
                <path
                    data-name="Drôme"
                    data-departmentnumber="26"
                    onClick={() => onDepartmentClick(26)}
                    className={computeMapItemClass(game, 26, 'region-84 department department-26 department-drome')}
                ...
                <path
                    data-name="Isère"
                    data-departmentnumber="38"
                    onClick={() => onDepartmentClick(38)}
                    className={computeMapItemClass(game, 38, 'region-84 department department-38 department-isere')}
                ...
                <path
                    data-name="Loire"
                    data-departmentnumber="42"
                    onClick={() => onDepartmentClick(42)}
                    className={computeMapItemClass(game, 42, 'region-84 department department-42 department-loire')}
                ...
                <path
                    ...
                    data-departmentnumber="43"
                    onClick={() => onDepartmentClick(43)}
                    className={computeMapItemClass(game, 43, 'region-84 department department-43 department-haute-loire')}
                ...
                <path
                    ...
                    data-departmentnumber="63"
                    onClick={() => onDepartmentClick(63)}
                    className={computeMapItemClass(game, 63, 'region-84 department department-63 department-puy-de-dome')}
                ...
                <path
                    data-name="Rhône"
                    data-departmentnumber="69"
                    onClick={() => onDepartmentClick(69)}
                    className={computeMapItemClass(game, 69, 'region-84 department department-69 department-rhone')}
                ...
                <path
                    data-name="Savoie"
                    data-departmentnumber="73"
                    onClick={() => onDepartmentClick(73)}
                    className={computeMapItemClass(game, 73, 'region-84 department department-73 department-savoie')}
                ...
                <path
                    ...
                    data-departmentnumber="74"
                    onClick={() => onDepartmentClick(74)}
                    className={computeMapItemClass(game, 74, 'region-84 department department-74 department-haute-savoie')}
            ...
            <g className="region region-93" data-name="Provence-Alpes-Côte d&#39;Azur" data-insee="93">
                <path
                    ...
                    data-departmentnumber="04"
                    onClick={() => onDepartmentClick(4)}
                    className={computeMapItemClass(game, 4, 'region-93 department department-04 department-alpes-de-haute-provence')}
                ...
                <path
                    ...
                    data-departmentnumber="05"
                    onClick={() => onDepartmentClick(5)}
                    className={computeMapItemClass(game, 5, 'region-93 department department-05 department-hautes-alpes')}
                ...
                <path
                    ...
                    data-departmentnumber="06"
                    onClick={() => onDepartmentClick(6)}
                    className={computeMapItemClass(game, 6, 'region-93 department department-06 department-alpes-maritimes')}
                ...
                <path
                    ...
                    data-departmentnumber="13"
                    onClick={() => onDepartmentClick(13)}
                    className={computeMapItemClass(game, 13, 'region-93 department department-13 department-bouches-du-rhone')}
                ...
                <path
                    data-name="Var"
                    data-departmentnumber="83"
                    onClick={() => onDepartmentClick(83)}
                    className={computeMapItemClass(game, 83, 'region-93 department department-83 department-var')}
                ...
                <path
                    data-name="Vaucluse"
                    data-departmentnumber="84"
                    onClick={() => onDepartmentClick(84)}
                    className={computeMapItemClass(game, 84, 'region-93 department department-84 department-vaucluse')}
            ...
            <g className="region region-94" data-name="Corse" data-insee="94">
                <path
                    ...
                    data-departmentnumber="2A"
                    onClick={() => onDepartmentClick('2A')}
                    className={computeMapItemClass(game, '2A', 'region-94 department department-2A department-corse-du-sud')}
                ...
                <path
                    ...
                    data-departmentnumber="2B"
                    onClick={() => onDepartmentClick('2B')}
                    className={computeMapItemClass(game, '2B', 'region-94 department department-2B department-haute-corse')}
...
MapDepartments.defaultProps = defaultProps;

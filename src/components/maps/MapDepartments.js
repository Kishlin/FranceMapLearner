// https://github.com/regisenguehard/carte-france-svg
// https://blog.enguehard.info/carte-de-france-regions-departments-en-svg/

import React from "react";

import "./MapDepartments.css";

import { computeMapItemClass } from "../../helpers";

class MapDepartments extends React.Component {
	render()
	{
		return (
			<svg ref={ref => this.map = ref} version="1.1" width="597.6" height="670.7" viewBox="0 0 597.6 670.7" overflow="visible">
				...
				{/*</g>*/}
				{/*<g className="region region-02" data-name="Martinique" data-insee="02">*/}
				{/*	<path data-name="Martinique" data-departmentnumber="972"*/}
				{/*		  className="region-02 department department-972 department-martinique"*/}
				...
				{/*</g>*/}
				{/*<g className="region region-03" data-name="Guyane" data-insee="03">*/}
				{/*	<path data-name="Guyane" data-departmentnumber="973"*/}
				{/*		  className="region-03 department department-973 department-guyane"*/}
				...
				{/*</g>*/}
				{/*<g className="region region-04" data-name="La Réunion" data-insee="04">*/}
				{/*	<path data-name="La Réunion" data-departmentnumber="974"*/}
				{/*		  className="region-04 department department-974 department-la-reunion"*/}
				...
				{/*</g>*/}
				{/*<g className="region region-06" data-name="Mayotte" data-insee="06">*/}
				{/*	<path data-name="Mayotte" data-departmentnumber="976"*/}
				{/*		  className="region-06 department department-976 department-mayotte"*/}
				...
				{/*</g>*/}
				<g className="region region-11" data-name="Île-de-France" data-insee="11">
					<path data-name="Paris" data-departmentnumber="75"
						  onClick={() => this.props.onDepartmentClick(75)}
						  className={computeMapItemClass(this.props.game,75,"region-11 department department-75 department-paris")}
					...
					<path data-name="Seine-et-Marne" data-departmentnumber="77"
						  onClick={() => this.props.onDepartmentClick(77)}
						  className={computeMapItemClass(this.props.game,77,"region-11 department department-77 department-seine-et-marne")}
					...
					<path data-name="Yvelines" data-departmentnumber="78"
						  onClick={() => this.props.onDepartmentClick(78)}
						  className={computeMapItemClass(this.props.game,78,"region-11 department department-78 department-yvelines")}
					...
					<path data-name="Essonne" data-departmentnumber="91"
						  onClick={() => this.props.onDepartmentClick(91)}
						  className={computeMapItemClass(this.props.game,91,"region-11 department department-91 department-essonne")}
					...
					<path data-name="Hauts-de-Seine" data-departmentnumber="92"
						  onClick={() => this.props.onDepartmentClick(92)}
						  className={computeMapItemClass(this.props.game,92,"region-11 department department-92 department-hauts-de-seine")}
					...
					<path data-name="Seine-Saint-Denis" data-departmentnumber="93"
						  onClick={() => this.props.onDepartmentClick(93)}
						  className={computeMapItemClass(this.props.game,93,"region-11 department department-93 department-seine-saint-denis")}
					...
					<path data-name="Val-de-Marne" data-departmentnumber="94"
						  onClick={() => this.props.onDepartmentClick(94)}
						  className={computeMapItemClass(this.props.game,94,"region-11 department department-94 department-val-de-marne")}
					...
					<path data-name="Val-d’Oise" data-departmentnumber="95"
						  onClick={() => this.props.onDepartmentClick(95)}
						  className={computeMapItemClass(this.props.game,95,"region-11 department department-95 department-val-doise")}
				...
				<g className="region region-24" data-name="Centre-Val de Loire" data-insee="24">
					<path data-name="Cher" data-departmentnumber="18"
						  onClick={() => this.props.onDepartmentClick(18)}
						  className={computeMapItemClass(this.props.game,18,"region-24 department department-18 department-cher")}
					...
					<path data-name="Eure-et-Loir" data-departmentnumber="28"
						  onClick={() => this.props.onDepartmentClick(28)}
						  className={computeMapItemClass(this.props.game,28,"region-24 department department-28 department-eure-et-loir")}
					...
					<path data-name="Indre" data-departmentnumber="36"
						  onClick={() => this.props.onDepartmentClick(36)}
						  className={computeMapItemClass(this.props.game,36,"region-24 department department-36 department-indre")}
					...
					<path data-name="Indre-et-Loire" data-departmentnumber="37"
						  onClick={() => this.props.onDepartmentClick(37)}
						  className={computeMapItemClass(this.props.game,37,"region-24 department department-37 department-indre-et-loire")}
					...
					<path data-name="Loir-et-Cher" data-departmentnumber="41"
						  onClick={() => this.props.onDepartmentClick(41)}
						  className={computeMapItemClass(this.props.game,41,"region-24 department department-41 department-loir-et-cher")}
					...
					<path data-name="Loiret" data-departmentnumber="45"
						  onClick={() => this.props.onDepartmentClick(45)}
						  className={computeMapItemClass(this.props.game,45,"region-24 department department-45 department-loiret")}
				...
				<g className="region region-27" data-name="Bourgogne-Franche-Comté" data-insee="27">
					<path data-name="Côte-d’Or" data-departmentnumber="21"
						  onClick={() => this.props.onDepartmentClick(21)}
						  className={computeMapItemClass(this.props.game,21,"region-27 department department-21 department-cote-dor")}
					...
					<path data-name="Doubs" data-departmentnumber="25"
						  onClick={() => this.props.onDepartmentClick(25)}
						  className={computeMapItemClass(this.props.game,25,"region-27 department department-25 department-doubs")}
					...
					<path data-name="Jura" data-departmentnumber="39"
						  onClick={() => this.props.onDepartmentClick(39)}
						  className={computeMapItemClass(this.props.game,39,"region-27 department department-39 department-jura")}
					...
					<path data-name="Nièvre" data-departmentnumber="58"
						  onClick={() => this.props.onDepartmentClick(58)}
						  className={computeMapItemClass(this.props.game,58,"region-27 department department-58 department-nievre")}
					...
					<path data-name="Haute-Saône" data-departmentnumber="70"
						  onClick={() => this.props.onDepartmentClick(70)}
						  className={computeMapItemClass(this.props.game,70,"region-27 department department-70 department-haute-saone")}
					...
					<path data-name="Saône-et-Loire" data-departmentnumber="71"
						  onClick={() => this.props.onDepartmentClick(71)}
						  className={computeMapItemClass(this.props.game,71,"region-27 department department-71 department-saone-et-loire")}
					...
					<path data-name="Yonne" data-departmentnumber="89"
						  onClick={() => this.props.onDepartmentClick(89)}
						  className={computeMapItemClass(this.props.game,89,"region-27 department department-89 department-yonne")}
					...
					<path data-name="Territoire de Belfort" data-departmentnumber="90"
						  onClick={() => this.props.onDepartmentClick(90)}
						  className={computeMapItemClass(this.props.game,90,"region-27 department department-90 department-territoire-de-belfort")}
				...
				<g className="region region-28" data-name="Normandie" data-insee="28">
					<path data-name="Calvados" data-departmentnumber="14"
						  onClick={() => this.props.onDepartmentClick(14)}
						  className={computeMapItemClass(this.props.game,14,"region-28 department department-14 department-calvados")}
					...
					<path data-name="Eure" data-departmentnumber="27"
						  onClick={() => this.props.onDepartmentClick(27)}
						  className={computeMapItemClass(this.props.game,27,"region-28 department department-27 department-eure")}
					...
					<path data-name="Manche" data-departmentnumber="50"
						  onClick={() => this.props.onDepartmentClick(50)}
						  className={computeMapItemClass(this.props.game,50,"region-28 department department-50 department-manche")}
					...
					<path data-name="Orne" data-departmentnumber="61"
						  onClick={() => this.props.onDepartmentClick(61)}
						  className={computeMapItemClass(this.props.game,61,"region-28 department department-61 department-orne")}
					...
					<path data-name="Seine-Maritime" data-departmentnumber="76"
						  onClick={() => this.props.onDepartmentClick(76)}
						  className={computeMapItemClass(this.props.game,76,"region-28 department department-76 department-seine-maritime")}
				...
				<g className="region region-32" data-name="Hauts-de-France" data-insee="32">
					<path data-name="Aisne" data-departmentnumber="02"
						  onClick={() => this.props.onDepartmentClick(2)}
						  className={computeMapItemClass(this.props.game,2,"region-32 department department-02 department-aisne")}
					...
					<path data-name="Nord" data-departmentnumber="59"
						  onClick={() => this.props.onDepartmentClick(59)}
						  className={computeMapItemClass(this.props.game,59,"region-32 department department-59 department-nord")}
					...
					<path data-name="Oise" data-departmentnumber="60"
						  onClick={() => this.props.onDepartmentClick(60)}
						  className={computeMapItemClass(this.props.game,60,"region-32 department department-60 department-oise")}
					...
					<path data-name="Pas-de-Calais" data-departmentnumber="62"
						  onClick={() => this.props.onDepartmentClick(62)}
						  className={computeMapItemClass(this.props.game,62,"region-32 department department-62 department-pas-de-calais")}
					...
					<path data-name="Somme" data-departmentnumber="80"
						  onClick={() => this.props.onDepartmentClick(80)}
						  className={computeMapItemClass(this.props.game,80,"region-32 department department-80 department-somme")}
						  d="m424.3,82.9l3.3,2.6l-0.4,3.8l-3.9,8.1l2.3,7 l-10.3,1.5l-8.6,6.8l-12.8-6.7l-14.4-2.2l-3.1,1.2l-4.1-3.7l-3.4-8.4l-11.79-9.99L359.5,81l3.4-6.6l1.9-1.1l0.1-0.1l1.4,1.8l3.5,0.3 l-5.6-6l1.2-5.1l2.9,0.7l-0.03-0.02l10.53,1.02l1,3l7.1,5.8l12-2.5l-2.6,5.7L398,81l2.5-3.1l8.4,3.5l0.8-2.8l2.8,4.6l2.4-1.7 l0.8,3.2L424.3,82.9z"/>
				</g>
				<g className="region region-44" data-name="Grand Est" data-insee="44">
					<path data-name="Ardennes" data-departmentnumber="08"
						  onClick={() => this.props.onDepartmentClick(8)}
						  className={computeMapItemClass(this.props.game,8,"region-44 department department-08 department-ardennes")}
					...
					<path data-name="Aube" data-departmentnumber="10"
						  onClick={() => this.props.onDepartmentClick(10)}
						  className={computeMapItemClass(this.props.game,10,"region-44 department department-10 department-aube")}
					...
					<path data-name="Marne" data-departmentnumber="51"
						  onClick={() => this.props.onDepartmentClick(51)}
						  className={computeMapItemClass(this.props.game,51,"region-44 department department-51 department-marne")}
					...
					<path data-name="Haute-Marne" data-departmentnumber="52"
						  onClick={() => this.props.onDepartmentClick(52)}
						  className={computeMapItemClass(this.props.game,52,"region-44 department department-52 department-haute-marne")}
					...
					<path data-name="Meurthe-et-Moselle" data-departmentnumber="54"
						  onClick={() => this.props.onDepartmentClick(54)}
						  className={computeMapItemClass(this.props.game,54,"region-44 department department-54 department-meurthe-et-moselle")}
					...
					<path data-name="Meuse" data-departmentnumber="55"
						  onClick={() => this.props.onDepartmentClick(55)}
						  className={computeMapItemClass(this.props.game,55,"region-44 department department-55 department-meuse")}
					...
					<path data-name="Moselle" data-departmentnumber="57"
						  onClick={() => this.props.onDepartmentClick(57)}
						  className={computeMapItemClass(this.props.game,57,"region-44 department department-57 department-moselle")}
					...
					<path data-name="Bas-Rhin" data-departmentnumber="67"
						  onClick={() => this.props.onDepartmentClick(67)}
						  className={computeMapItemClass(this.props.game,67,"region-44 department department-67 department-bas-rhin")}
					...
					<path data-name="Haut-Rhin" data-departmentnumber="68"
						  onClick={() => this.props.onDepartmentClick(68)}
						  className={computeMapItemClass(this.props.game,68,"region-44 department department-68 department-haut-rhin")}
					...
					<path data-name="Vosges" data-departmentnumber="88"
						  onClick={() => this.props.onDepartmentClick(88)}
						  className={computeMapItemClass(this.props.game,88,"region-44 department department-88 department-vosges")}
				...
				<g className="region region-52" data-name="Pays de la Loire" data-insee="52">
					<path data-name="Loire-Atlantique" data-departmentnumber="44"
						  onClick={() => this.props.onDepartmentClick(44)}
						  className={computeMapItemClass(this.props.game,44,"region-52 department department-44 department-loire-atlantique")}
					...
					<path data-name="Maine-et-Loire" data-departmentnumber="49"
						  onClick={() => this.props.onDepartmentClick(49)}
						  className={computeMapItemClass(this.props.game,49,"region-52 department department-49 department-maine-et-loire")}
					...
					<path data-name="Mayenne" data-departmentnumber="53"
						  onClick={() => this.props.onDepartmentClick(53)}
						  className={computeMapItemClass(this.props.game,53,"region-52 department department-53 department-mayenne")}
					...
					<path data-name="Sarthe" data-departmentnumber="72"
						  onClick={() => this.props.onDepartmentClick(72)}
						  className={computeMapItemClass(this.props.game,72,"region-52 department department-72 department-sarthe")}
					...
					<path data-name="Vendée" data-departmentnumber="85"
						  onClick={() => this.props.onDepartmentClick(85)}
						  className={computeMapItemClass(this.props.game,85,"region-52 department department-85 department-vendee")}
				...
				<g className="region region-53" data-name="Bretagne" data-insee="53">
					<path data-name="Côtes-d’Armor" data-departmentnumber="22"
						  onClick={() => this.props.onDepartmentClick(22)}
						  className={computeMapItemClass(this.props.game,22,"region-53 department department-22 department-cotes-darmor")}
					...
					<path data-name="Finistère" data-departmentnumber="29"
						  onClick={() => this.props.onDepartmentClick(29)}
						  className={computeMapItemClass(this.props.game,29,"region-53 department department-29 department-finistere")}
					...
					<path data-name="Ille-et-Vilaine" data-departmentnumber="35"
						  onClick={() => this.props.onDepartmentClick(35)}
						  className={computeMapItemClass(this.props.game,35,"region-53 department department-35 department-ille-et-vilaine")}
					...
					<path data-name="Morbihan" data-departmentnumber="56"
						  onClick={() => this.props.onDepartmentClick(56)}
						  className={computeMapItemClass(this.props.game,56,"region-53 department department-56 department-morbihan")}
				...
				<g className="region region-75" data-name="Nouvelle-Aquitaine" data-insee="75">
					<path data-name="Charente" data-departmentnumber="16"
						  onClick={() => this.props.onDepartmentClick(16)}
						  className={computeMapItemClass(this.props.game,16,"region-75 department department-16 department-charente")}
					...
					<path data-name="Charente-Maritime" data-departmentnumber="17"
						  onClick={() => this.props.onDepartmentClick(17)}
						  className={computeMapItemClass(this.props.game,17,"region-75 department department-17 department-charente-maritime")}
					...
					<path data-name="Corrèze" data-departmentnumber="19"
						  onClick={() => this.props.onDepartmentClick(19)}
						  className={computeMapItemClass(this.props.game,19,"region-75 department department-19 department-correze")}
					...
					<path data-name="Creuse" data-departmentnumber="23"
						  onClick={() => this.props.onDepartmentClick(23)}
						  className={computeMapItemClass(this.props.game,23,"region-75 department department-23 department-creuse")}
					...
					<path data-name="Dordogne" data-departmentnumber="24"
						  onClick={() => this.props.onDepartmentClick(24)}
						  className={computeMapItemClass(this.props.game,24,"region-75 department department-24 department-dordogne")}
					...
					<path data-name="Gironde" data-departmentnumber="33"
						  onClick={() => this.props.onDepartmentClick(33)}
						  className={computeMapItemClass(this.props.game,33,"region-75 department department-33 department-gironde")}
					...
					<path data-name="Landes" data-departmentnumber="40"
						  onClick={() => this.props.onDepartmentClick(40)}
						  className={computeMapItemClass(this.props.game,40,"region-75 department department-40 department-landes")}
					...
					<path data-name="Lot-et-Garonne" data-departmentnumber="47"
						  onClick={() => this.props.onDepartmentClick(47)}
						  className={computeMapItemClass(this.props.game,47,"region-75 department department-47 department-lot-et-garonne")}
						  d="m293.8,455.6v0.1l-0.7-2.6l3.6-5.2L285,445 l-0.4-4.6l4.5-4l-1.5-2.5l3-2.3l0.6-8.9l8.5-8.6l-2.9-1.4l1.1-3.3l2.7,0.9l1.2-2.5l3.1,0.1l2.8,6.4l8.9-0.5l2.8-2l2.2,1.8l6.1-1 l1.5,6l5.4-2.7l4.2,4.2l-3.4,3.1l2.7,9.1l-7.5,2v2.9l2.4,1.4l-4.4,5.5l1.3,2.7l-2.8-0.2l-3.6,4.7l-2.7,1.3l-8.6-1l-5,2.9l-8.3-0.7 l-1.4,2.5L293.8,455.6z"/>
					<path data-name="Pyrénées-Atlantiques" data-departmentnumber="64"
						  onClick={() => this.props.onDepartmentClick(64)}
						  className={computeMapItemClass(this.props.game,64,"region-75 department department-64 department-pyrenees-atlantiques")}
					...
					<path data-name="Deux-Sèvres" data-departmentnumber="79"
						  onClick={() => this.props.onDepartmentClick(79)}
						  className={computeMapItemClass(this.props.game,79,"region-75 department department-79 department-deux-sevres")}
					...
					<path data-name="Vienne" data-departmentnumber="86"
						  onClick={() => this.props.onDepartmentClick(86)}
						  className={computeMapItemClass(this.props.game,86,"region-75 department department-86 department-vienne")}
					...
					<path data-name="Haute-Vienne" data-departmentnumber="87"
						  onClick={() => this.props.onDepartmentClick(87)}
						  className={computeMapItemClass(this.props.game,87,"region-75 department department-87 department-haute-vienne")}
				...
				<g className="region region-76" data-name="Occitanie" data-insee="76">
					<path data-name="Ariège" data-departmentnumber="09"
						  onClick={() => this.props.onDepartmentClick(9)}
						  className={computeMapItemClass(this.props.game,9,"region-76 department department-09 department-ariege")}
					...
					<path data-name="Aude" data-departmentnumber="11"
						  onClick={() => this.props.onDepartmentClick(11)}
						  className={computeMapItemClass(this.props.game,11,"region-76 department department-11 department-aude")}
						  d="m435.07,504.37l-1.47,1.53l-5.2,9.3l-0.9,3.5 l0.15,9.57l-9.45-5.57l-8.2,5.4l-13.6-1l-2.7,1.4l1.4,6l-8.6,3.9l-4.8-5.6l-3.3,1.2l-3.4-1.5l-0.8-5.7l3.2-0.6l1.2-3l-2.4-2.5 l2.2-2.3l-0.2-3.1l-2.2-5.2l-8.7-3.9l-2.2-5.5l8.4-10l1.4,2.7l5.2-1.8l0.5-0.8l1.8,2.3l6.3,0.9l1.1-3.3l2.8-0.5l12,1.4l-0.5,2.8 l3.5,5l2.5-1.6l1.4,2.9l3.1-0.8l3.8-5.3l1,2.9l13.8,4.7l1.7,2L435.07,504.37z"/>
					<path data-name="Aveyron" data-departmentnumber="12"
						  onClick={() => this.props.onDepartmentClick(12)}
						  className={computeMapItemClass(this.props.game,12,"region-76 department department-12 department-aveyron")}
					...
					<path data-name="Gard" data-departmentnumber="30"
						  onClick={() => this.props.onDepartmentClick(30)}
						  className={computeMapItemClass(this.props.game,30,"region-76 department department-30 department-gard")}
					...
					<path data-name="Haute-Garonne" data-departmentnumber="31"
						  onClick={() => this.props.onDepartmentClick(31)}
						  className={computeMapItemClass(this.props.game,31,"region-76 department department-31 department-haute-garonne")}
					...
					<path data-name="Gers" data-departmentnumber="32"
						  onClick={() => this.props.onDepartmentClick(32)}
						  className={computeMapItemClass(this.props.game,32,"region-76 department department-32 department-gers")}
					...
					<path data-name="Hérault" data-departmentnumber="34"
						  onClick={() => this.props.onDepartmentClick(34)}
						  className={computeMapItemClass(this.props.game,34,"region-76 department department-34 department-herault")}
					...
					<path data-name="Lot" data-departmentnumber="46"
						  onClick={() => this.props.onDepartmentClick(46)}
						  className={computeMapItemClass(this.props.game,46,"region-76 department department-46 department-lot")}
					...
					<path data-name="Lozère" data-departmentnumber="48"
						  onClick={() => this.props.onDepartmentClick(48)}
						  className={computeMapItemClass(this.props.game,48,"region-76 department department-48 department-lozere")}
					...
					<path data-name="Hautes-Pyrénées" data-departmentnumber="65"
						  onClick={() => this.props.onDepartmentClick(65)}
						  className={computeMapItemClass(this.props.game,65,"region-76 department department-65 department-hautes-pyrenees")}
					...
					<path data-name="Pyrénées-Orientales" data-departmentnumber="66"
						  onClick={() => this.props.onDepartmentClick(66)}
						  className={computeMapItemClass(this.props.game,66,"region-76 department department-66 department-pyrenees-orientales")}
					...
					<path data-name="Tarn" data-departmentnumber="81"
						  onClick={() => this.props.onDepartmentClick(81)}
						  className={computeMapItemClass(this.props.game,81,"region-76 department department-81 department-tarn")}
					...
					<path data-name="Tarn-et-Garonne" data-departmentnumber="82"
						  onClick={() => this.props.onDepartmentClick(82)}
						  className={computeMapItemClass(this.props.game,82,"region-76 department department-82 department-tarn-et-garonne")}
				...
				<g className="region region-84" data-name="Auvergne-Rhône-Alpes" data-insee="84">
					<path data-name="Ain" data-departmentnumber="01"
						  onClick={() => this.props.onDepartmentClick(1)}
						  className={computeMapItemClass(this.props.game,1,"region-84 department department-01 department-ain")}
					...
					<path data-name="Allier" data-departmentnumber="03"
						  onClick={() => this.props.onDepartmentClick(3)}
						  className={computeMapItemClass(this.props.game,3,"region-84 department department-03 department-allier")}
					...
					<path data-name="Ardèche" data-departmentnumber="07"
						  onClick={() => this.props.onDepartmentClick(7)}
						  className={computeMapItemClass(this.props.game,7,"region-84 department department-07 department-ardeche")}
					...
					<path data-name="Cantal" data-departmentnumber="15"
						  onClick={() => this.props.onDepartmentClick(15)}
						  className={computeMapItemClass(this.props.game,15,"region-84 department department-15 department-cantal")}
					...
					<path data-name="Drôme" data-departmentnumber="26"
						  onClick={() => this.props.onDepartmentClick(26)}
						  className={computeMapItemClass(this.props.game,26,"region-84 department department-26 department-drome")}
					...
					<path data-name="Isère" data-departmentnumber="38"
						  onClick={() => this.props.onDepartmentClick(38)}
						  className={computeMapItemClass(this.props.game,38,"region-84 department department-38 department-isere")}
					...
					<path data-name="Loire" data-departmentnumber="42"
						  onClick={() => this.props.onDepartmentClick(42)}
						  className={computeMapItemClass(this.props.game,42,"region-84 department department-42 department-loire")}
					...
					<path data-name="Haute-Loire" data-departmentnumber="43"
						  onClick={() => this.props.onDepartmentClick(43)}
						  className={computeMapItemClass(this.props.game,43,"region-84 department department-43 department-haute-loire")}
					...
					<path data-name="Puy-de-Dôme" data-departmentnumber="63"
						  onClick={() => this.props.onDepartmentClick(63)}
						  className={computeMapItemClass(this.props.game,63,"region-84 department department-63 department-puy-de-dome")}
					...
					<path data-name="Rhône" data-departmentnumber="69"
						  onClick={() => this.props.onDepartmentClick(69)}
						  className={computeMapItemClass(this.props.game,69,"region-84 department department-69 department-rhone")}
					...
					<path data-name="Savoie" data-departmentnumber="73"
						  onClick={() => this.props.onDepartmentClick(73)}
						  className={computeMapItemClass(this.props.game,73,"region-84 department department-73 department-savoie")}
					...
					<path data-name="Haute-Savoie" data-departmentnumber="74"
						  onClick={() => this.props.onDepartmentClick(74)}
						  className={computeMapItemClass(this.props.game,74,"region-84 department department-74 department-haute-savoie")}
				...
				<g className="region region-93" data-name="Provence-Alpes-Côte d&#39;Azur" data-insee="93">
					<path data-name="Alpes-de-Haute-Provence" data-departmentnumber="04"
						  onClick={() => this.props.onDepartmentClick(4)}
						  className={computeMapItemClass(this.props.game, 4, "region-93 department department-04 department-alpes-de-haute-provence")}
					...
					<path data-name="Hautes-Alpes" data-departmentnumber="05"
						  onClick={() => this.props.onDepartmentClick(5)}
						  className={computeMapItemClass(this.props.game, 5, "region-93 department department-05 department-hautes-alpes")}
					...
					<path data-name="Alpes-Maritimes" data-departmentnumber="06"
						  onClick={() => this.props.onDepartmentClick(6)}
						  className={computeMapItemClass(this.props.game, 6, "region-93 department department-06 department-alpes-maritimes")}
					...
					<path data-name="Bouches-du-Rhône" data-departmentnumber="13"
						  onClick={() => this.props.onDepartmentClick(13)}
						  className={computeMapItemClass(this.props.game, 13, "region-93 department department-13 department-bouches-du-rhone")}
					...
					<path data-name="Var" data-departmentnumber="83"
						  onClick={() => this.props.onDepartmentClick(83)}
						  className={computeMapItemClass(this.props.game, 83, "region-93 department department-83 department-var")}
					...
					<path data-name="Vaucluse" data-departmentnumber="84"
						  onClick={() => this.props.onDepartmentClick(84)}
						  className={computeMapItemClass(this.props.game, 84, "region-93 department department-84 department-vaucluse")}
				...
				<g className="region region-94" data-name="Corse" data-insee="94">
					<path data-name="Corse-du-Sud" data-departmentnumber="2A"
						  onClick={() => this.props.onDepartmentClick("2A")}
						  className={computeMapItemClass(this.props.game, "2A", "region-94 department department-2A department-corse-du-sud")}
					...
					<path data-name="Haute-Corse" data-departmentnumber="2B"
						  onClick={() => this.props.onDepartmentClick("2B")}
						  className={computeMapItemClass(this.props.game, "2B", "region-94 department department-2B department-haute-corse")}

...
function MapRegions(props) {
    ...
    return (
        <svg
            ...
            width="597.6"
            height="670.7"
            viewBox="0 0 597.6 670.7"
            overflow="visible"
        >
            <g>
                <path onClick={() => props.onRegionClick(0)} className={computeClass(props.game, 0)} d="M503.3,105.4l-5,3.9l-3.1,0.1l-5.8-2.6l-4-3.3h-7.7l-1.4,3.1l-6.3,0.8l-3.9-8.1l-3.5,0.3v-3.5l-6.8-1.7
                ...
                <path onClick={() => props.onRegionClick(1)} className={computeClass(props.game, 1)} d="M335.6,1l-18.3,4.6l-15.4,4.8l-6.5,5.6v20.2l3.3,3.9l-3.1-1.9l-0.8,6.6l0.5,4.3l2.6,1.8l-4.2,1.6l-0.4,3.4
                ...
                <path onClick={() => props.onRegionClick(2)} className={computeClass(props.game, 2)} d="M328.3,131.8l-2.5,1.8l-10.3-2.5l-7.1,2.1l-6.3-1.3l-1.8-3.6l-4.4,10.6h-4.3l-2.7,2.8l2,6.6l4.2,7.4
                ...
                <path onClick={() => props.onRegionClick(3)} className={computeClass(props.game, 3)} d="M422.4,215.5l-2.5,2.2l-3.301-1.5l-14.1,1.8l-5.6-12.3L392.8,201l-2.2,2.5l-2.8-9.3l-5-6.2l-4.1-1.7
                ...
                <path onClick={() => props.onRegionClick(4)} className={computeClass(props.game, 4)} d="M344.2,205.3l-10.3-0.8l3-1.7l0.6-3l-4.7-4.8l-0.8-3.5l-4.2-0.6l-3.1,1.9l-1.7-2.9l-2.1,3.1l-7.801,0.9l0,0
                ...
                <path onClick={() => props.onRegionClick(5)} className={computeClass(props.game, 5)} d="M342.6,304.3l-2.5,2.1l1.9,6l-1.9,2.7l-9.8,1.1l-3.899,6.7l0,0l1.199,4.4c2.801,1.8,5.601,3.6,8.301,5.5
                ...
                <path onClick={() => props.onRegionClick(6)} className={computeClass(props.game, 6)} d="M326.4,322.9l-5.5-0.2l-3.101,0.9l-14.9-3l-2.1,2.8l-12.9,1.2l-3.1,3.2l-1.9-2.7l-6.5,1.2l-3-1.2l1.8-3.2
                ...
                <path onClick={() => props.onRegionClick(7)} className={computeClass(props.game, 7)} d="M178.5,114l-6,2.6l-7.2-11.8l2.8-8.8l-1.2-3.1l-7.3-0.8l-2.8,2l-7.3,0.5l-12.8-5.2l-0.2,3.2l3.7,2l0.6,5.5
                ...
                />
                <path onClick={() => props.onRegionClick(8)} className={computeClass(props.game, 8)} d="M114,161.8l-4,0.3l-12.1,10l-1-4.1l-4.5-2.9l-0.1-3.5l-5.1-8.8l-3.3-0.7l0.7-3.2l-3.4,0.4l-1.9,3.3l1.5-7.4
                ...
                <path onClick={() => props.onRegionClick(9)} className={computeClass(props.game, 9)} d="M144.2,225.8l-1.8,3.2l-14.7,0.5l-5.9,3.8l-0.4,6.7l-17.3,5.1l-5,4.9l2.7,6.9l6.8,1.2l2.3,2.2l5.5-4.1
                ...
                <path onClick={() => props.onRegionClick(10)} className={computeClass(props.game, 10)} d="M302,425.601l-7.6-6.801l-9,0.801l-0.8,5.699l-1.6,6l-5.1,3.601l0.8,4l-6.8,3.8l-5.3,7.2l-3.8,3.6l3,10.2
                ...
                <path onClick={() => props.onRegionClick(11)} className={computeClass(props.game, 11)} d="M558.1,425.4l-6.8-0.3l-5.899-3.7l-0.9-7.4l-3.1-0.1L538.8,408l0,0l-6.8,1.3l-2.3,2.2l-8.7-3.899l-1.7,4.3
                ...
                <path onClick={() => props.onRegionClick(12)} className={computeClass(props.game, 12)} d="M569.8,578.9l0.601-12l-2-10.2l-3.2-1.2l-2.601,2.3l0.5,19.5l-9.699-1.5l-3.9,5.5l-12.1,4.801l-0.9,3.199
                ...
                <line fill="none" stroke="#8CA2C0" x1="556.1" y1="438.5" x2="556.3" y2="438.2"/>
                <polyline fill="none" stroke="#8CA2C0" points="206.4,540
		203.9,538.2 206.3,536.9 206.4,540"/>
                <polyline fill="none" stroke="#8CA2C0" points="122.2,530.4
		...
		314.5,603.9 319.5,599.4 323.1,599.2 333.7,601.7 338.9,605.7 345.9,605.2 345.9,601.801 355,597.101 362.1,595.8 371.7,598.4"/>
                <polyline fill="none" stroke="#8CA2C0" points="586.8,498.101
		...
		"/>
                <polyline fill="none" stroke="#8CA2C0" points="471,238.3
		...
		396.9,205.7 392.8,201 390.6,203.5 387.8,194.2 382.8,188 378.7,186.3"/>
                <polyline fill="none" stroke="#8CA2C0" points="378.7,186.3
		378.2,176.7 381.5,175.9 384.9,170.3 382,168.4 378.1,159.1 380.9,156.6 381.5,154.3"/>
                <polyline fill="none" stroke="#8CA2C0" points="356.8,202.3
		...
		354.4,260.6 357.5,263 361,271.5 361.3,278.1 363.8,280.3 363.5,286.9 362,296.9"/>
                <path className="stroke" fill="none" stroke="#8CA2C0" d="M315.5,422.8l3.7-2.199
		...
		l0.6-4.6l-4.1-9.3c-2.7-1.9-5.5-3.7-8.301-5.5l-1.199-4.4l0,0l3.899-6.7l9.8-1.1l1.9-2.7l-1.9-6l2.5-2.1l9.5-3.2l5.4-4.2h4.5"/>
                <polyline fill="none" stroke="#8CA2C0" points="371.7,598.4
		...
		420.8,525.7 424.2,526.5 424.4,526.5"/>
                <polyline fill="none" stroke="#8CA2C0" points="326.4,322.9
		...
		232.5,283.6 231,276.8 227.7,277.1 227.4,273.5 221.3,269.9"/>
                <polyline fill="none" stroke="#8CA2C0" points="507,319.2
		...
		390.4,299.7 383.7,306.4 378.9,302.3 375.7,304.2 368.5,304 362,296.9"/>
                <polyline fill="none" stroke="#8CA2C0" points="461.9,465.5
		457.4,466.9 455.2,464.4 456.6,461 459.6,458.5 464.6,461.5 461.9,465.5"/>
                <polyline fill="none" stroke="#8CA2C0" points="553.4,241.4
		...
		493.8,215.1 494.1,216.7 491.5,220.3 488.3,219.9 486,222.6 485.6,232 482.2,233.1 479.7,231.1 472.3,235.5 471,238.3"/>
                ...
                <line fill="none" stroke="#8CA2C0" x1="471" y1="238.3" x2="471" y2="238.3"/>

                <line fill="none" stroke="#8CA2C0" x1="471" y1="238.3" x2="471" y2="238.3"/>

                <line fill="none" stroke="#8CA2C0" x1="471" y1="238.3" x2="474.1" y2="236.4"/>
                <polyline fill="none" stroke="#8CA2C0" points="236.9,113.7
		...
		18.9,193.1 4.7,194.5 3,197.3 13.7,201.3 17.9,208.3 16.7,214.5 24.9,215.2 29,210.5 29,210.1"/>
                <polyline fill="none" stroke="#8CA2C0" points="29,210.1
		...
		90.2,232.6 92.6,235.3 90.4,238.1 83.3,237.2 88.7,241.4 102.6,240.3 105.7,242 102.3,242.2 104.1,245.1"/>
                <polyline fill="none" stroke="#8CA2C0" points="172.4,175.1
		...
		121.4,240 104.1,245.1"/>
                <polyline fill="none" stroke="#8CA2C0" points="29.3,206.6
		31.3,206.3 29.7,203.1 29.3,206.6"/>
                <polyline fill="none" stroke="#8CA2C0" points="413.8,77.3
		...
		386.4,135.7 388.2,138.4 387.2,141.5 390,142.9 381.5,154.3"/>
                ...
                <line fill="none" stroke="#8CA2C0" x1="29" y1="210.1" x2="29.3" y2="206.6"/>
                <polyline fill="none" stroke="#8CA2C0" points="111.6,274.7
		109.5,277.2 116.3,283.8 116.1,280.2 112.7,278.2 111.6,274.7"/>
                <polyline fill="none" stroke="#8CA2C0" points="104.1,245.1
		...
		159.6,326.5 162.8,327"/>
                <polyline fill="none" stroke="#8CA2C0" points="74.9,252.3
		69.2,248.5 66,248.9 67,252.6 70.5,253.7 74.9,252.3"/>
                <polyline fill="none" stroke="#8CA2C0" points="146.7,332.6
		143.9,330.2 144,330.4"/>
                <polyline fill="none" stroke="#8CA2C0" points="144,330.4
		143.7,330.2 145,333.2 145.8,332.9"/>
                <polyline fill="none" stroke="#8CA2C0" points="290.9,148.3
		288.9,141.7 291.6,138.9 295.9,138.9 300.3,128.3"/>
                <polyline fill="none" stroke="#8CA2C0" points="257.9,199.5
		...
		215.2,180.6 213,173.8 209.9,173.5 209.1,176.6 198.9,176.6 191.3,180.3 188.5,178.4 185.8,180.2 182.1,176 172.4,175.1"/>
                <polyline fill="none" stroke="#8CA2C0" points="221.3,269.9
		...
		146.7,332.6 146.6,332.7"/>
                <polyline fill="none" stroke="#8CA2C0" points="146.6,332.7
		146.5,332.6 146.7,332.6"/>

                <line fill="none" stroke="#8CA2C0" x1="145.8" y1="332.9" x2="146.5" y2="332.7"/>

                <line fill="none" stroke="#8CA2C0" x1="146.5" y1="332.7" x2="146.6" y2="332.7"/>
                <polyline fill="none" stroke="#8CA2C0" points="145.8,332.9
		145.1,333.2 144,330.4"/>
                <polyline fill="none" stroke="#8CA2C0" points="146.6,332.7
		151.6,337.2 154.9,335.8 148.8,331.9 146.7,332.6"/>

                <line fill="none" stroke="#8CA2C0" x1="144" y1="330.4" x2="146.5" y2="332.7"/>
                <polyline fill="none" stroke="#8CA2C0" points="315.5,422.8
		...
		200.4,550.601 200.9,553.9 197.1,554.8 195.3,558 193.9,567.601 193.9,567.7"/>
                <polyline fill="none" stroke="#8CA2C0" points="151,346.2
		149.1,349.3 156.3,361.9 157.8,358.3 156.8,350 151,346.2"/>
                <polyline fill="none" stroke="#8CA2C0" points="162.8,327
		...
		161.8,441.9 154.6,440.9 151,448.601 151.1,453.9 138.8,510.101 134.5,518.101 134.4,518.101 129.3,525.2 122.2,530.4"/>
                <polyline fill="none" stroke="#8CA2C0" points="381.5,154.3
		...
		325.8,133.6 315.5,131.1 308.4,133.2 302.1,131.9 300.3,128.3"/>
                <polyline fill="none" stroke="#8CA2C0" points="335.6,1
		...
		296.7,62.1 293.6,60.4 286.3,70.4"/>
                <polyline fill="none" stroke="#8CA2C0" points="538.8,408
		...
		569.4,511.601 570.6,506.9 586.8,498.101"/>
                <polyline fill="none" stroke="#8CA2C0" points="443.9,469.9
		...
		428.7,519.9 435.2,517.9 434.1,514.801 438.8,509.4 442.5,510.4 444.6,498.5 454.1,488.301 447,481.101 446.8,475 443.9,469.9"/>
                <polyline fill="none" stroke="#8CA2C0" points="570.4,566.9

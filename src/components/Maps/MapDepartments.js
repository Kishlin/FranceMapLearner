		...
		<svg /*ref={ref => this.map = ref}*/ version="1.1" width="597.6" height="670.7" viewBox="0 0 597.6 670.7" overflow="visible">
			...
			<g className="region region-11" data-name="Île-de-France" data-insee="11">
				<path data-name="Paris" data-departmentnumber="75"
					  onClick={() => props.onDepartmentClick(75)}
					  className={computeMapItemClass(props.game,75,"region-11 department department-75 department-paris")}
				...
				<path data-name="Seine-et-Marne" data-departmentnumber="77"
					  onClick={() => props.onDepartmentClick(77)}
					  className={computeMapItemClass(props.game,77,"region-11 department department-77 department-seine-et-marne")}
				...
				<path data-name="Yvelines" data-departmentnumber="78"
					  onClick={() => props.onDepartmentClick(78)}
					  className={computeMapItemClass(props.game,78,"region-11 department department-78 department-yvelines")}
				...
				<path data-name="Essonne" data-departmentnumber="91"
					  onClick={() => props.onDepartmentClick(91)}
					  className={computeMapItemClass(props.game,91,"region-11 department department-91 department-essonne")}
				...
				<path data-name="Hauts-de-Seine" data-departmentnumber="92"
					  onClick={() => props.onDepartmentClick(92)}
					  className={computeMapItemClass(props.game,92,"region-11 department department-92 department-hauts-de-seine")}
				...
				<path data-name="Seine-Saint-Denis" data-departmentnumber="93"
					  onClick={() => props.onDepartmentClick(93)}
					  className={computeMapItemClass(props.game,93,"region-11 department department-93 department-seine-saint-denis")}
				...
				<path data-name="Val-de-Marne" data-departmentnumber="94"
					  onClick={() => props.onDepartmentClick(94)}
					  className={computeMapItemClass(props.game,94,"region-11 department department-94 department-val-de-marne")}
				...
				<path data-name="Val-d’Oise" data-departmentnumber="95"
					  onClick={() => props.onDepartmentClick(95)}
					  className={computeMapItemClass(props.game,95,"region-11 department department-95 department-val-doise")}
			...
			<g className="region region-24" data-name="Centre-Val de Loire" data-insee="24">
				<path data-name="Cher" data-departmentnumber="18"
					  onClick={() => props.onDepartmentClick(18)}
					  className={computeMapItemClass(props.game,18,"region-24 department department-18 department-cher")}
				...
				<path data-name="Eure-et-Loir" data-departmentnumber="28"
					  onClick={() => props.onDepartmentClick(28)}
					  className={computeMapItemClass(props.game,28,"region-24 department department-28 department-eure-et-loir")}
				...
				<path data-name="Indre" data-departmentnumber="36"
					  onClick={() => props.onDepartmentClick(36)}
					  className={computeMapItemClass(props.game,36,"region-24 department department-36 department-indre")}
				...
				<path data-name="Indre-et-Loire" data-departmentnumber="37"
					  onClick={() => props.onDepartmentClick(37)}
					  className={computeMapItemClass(props.game,37,"region-24 department department-37 department-indre-et-loire")}
				...
				<path data-name="Loir-et-Cher" data-departmentnumber="41"
					  onClick={() => props.onDepartmentClick(41)}
					  className={computeMapItemClass(props.game,41,"region-24 department department-41 department-loir-et-cher")}
				...
				<path data-name="Loiret" data-departmentnumber="45"
					  onClick={() => props.onDepartmentClick(45)}
					  className={computeMapItemClass(props.game,45,"region-24 department department-45 department-loiret")}
			...
			<g className="region region-27" data-name="Bourgogne-Franche-Comté" data-insee="27">
				<path data-name="Côte-d’Or" data-departmentnumber="21"
					  onClick={() => props.onDepartmentClick(21)}
					  className={computeMapItemClass(props.game,21,"region-27 department department-21 department-cote-dor")}
				...
				<path data-name="Doubs" data-departmentnumber="25"
					  onClick={() => props.onDepartmentClick(25)}
					  className={computeMapItemClass(props.game,25,"region-27 department department-25 department-doubs")}
				...
				<path data-name="Jura" data-departmentnumber="39"
					  onClick={() => props.onDepartmentClick(39)}
					  className={computeMapItemClass(props.game,39,"region-27 department department-39 department-jura")}
				...
				<path data-name="Nièvre" data-departmentnumber="58"
					  onClick={() => props.onDepartmentClick(58)}
					  className={computeMapItemClass(props.game,58,"region-27 department department-58 department-nievre")}
				...
				<path data-name="Haute-Saône" data-departmentnumber="70"
					  onClick={() => props.onDepartmentClick(70)}
					  className={computeMapItemClass(props.game,70,"region-27 department department-70 department-haute-saone")}
				...
				<path data-name="Saône-et-Loire" data-departmentnumber="71"
					  onClick={() => props.onDepartmentClick(71)}
					  className={computeMapItemClass(props.game,71,"region-27 department department-71 department-saone-et-loire")}
				...
				<path data-name="Yonne" data-departmentnumber="89"
					  onClick={() => props.onDepartmentClick(89)}
					  className={computeMapItemClass(props.game,89,"region-27 department department-89 department-yonne")}
				...
				<path data-name="Territoire de Belfort" data-departmentnumber="90"
					  onClick={() => props.onDepartmentClick(90)}
					  className={computeMapItemClass(props.game,90,"region-27 department department-90 department-territoire-de-belfort")}
			...
			<g className="region region-28" data-name="Normandie" data-insee="28">
				<path data-name="Calvados" data-departmentnumber="14"
					  onClick={() => props.onDepartmentClick(14)}
					  className={computeMapItemClass(props.game,14,"region-28 department department-14 department-calvados")}
				...
				<path data-name="Eure" data-departmentnumber="27"
					  onClick={() => props.onDepartmentClick(27)}
					  className={computeMapItemClass(props.game,27,"region-28 department department-27 department-eure")}
				...
				<path data-name="Manche" data-departmentnumber="50"
					  onClick={() => props.onDepartmentClick(50)}
					  className={computeMapItemClass(props.game,50,"region-28 department department-50 department-manche")}
				...
				<path data-name="Orne" data-departmentnumber="61"
					  onClick={() => props.onDepartmentClick(61)}
					  className={computeMapItemClass(props.game,61,"region-28 department department-61 department-orne")}
				...
				<path data-name="Seine-Maritime" data-departmentnumber="76"
					  onClick={() => props.onDepartmentClick(76)}
					  className={computeMapItemClass(props.game,76,"region-28 department department-76 department-seine-maritime")}
			...
			<g className="region region-32" data-name="Hauts-de-France" data-insee="32">
				<path data-name="Aisne" data-departmentnumber="02"
					  onClick={() => props.onDepartmentClick(2)}
					  className={computeMapItemClass(props.game,2,"region-32 department department-02 department-aisne")}
				...
				<path data-name="Nord" data-departmentnumber="59"
					  onClick={() => props.onDepartmentClick(59)}
					  className={computeMapItemClass(props.game,59,"region-32 department department-59 department-nord")}
				...
				<path data-name="Oise" data-departmentnumber="60"
					  onClick={() => props.onDepartmentClick(60)}
					  className={computeMapItemClass(props.game,60,"region-32 department department-60 department-oise")}
				...
				<path data-name="Pas-de-Calais" data-departmentnumber="62"
					  onClick={() => props.onDepartmentClick(62)}
					  className={computeMapItemClass(props.game,62,"region-32 department department-62 department-pas-de-calais")}
				...
				<path data-name="Somme" data-departmentnumber="80"
					  onClick={() => props.onDepartmentClick(80)}
					  className={computeMapItemClass(props.game,80,"region-32 department department-80 department-somme")}
			...
			<g className="region region-44" data-name="Grand Est" data-insee="44">
				<path data-name="Ardennes" data-departmentnumber="08"
					  onClick={() => props.onDepartmentClick(8)}
					  className={computeMapItemClass(props.game,8,"region-44 department department-08 department-ardennes")}
				...
				<path data-name="Aube" data-departmentnumber="10"
					  onClick={() => props.onDepartmentClick(10)}
					  className={computeMapItemClass(props.game,10,"region-44 department department-10 department-aube")}
				...
				<path data-name="Marne" data-departmentnumber="51"
					  onClick={() => props.onDepartmentClick(51)}
					  className={computeMapItemClass(props.game,51,"region-44 department department-51 department-marne")}
				...
				<path data-name="Haute-Marne" data-departmentnumber="52"
					  onClick={() => props.onDepartmentClick(52)}
					  className={computeMapItemClass(props.game,52,"region-44 department department-52 department-haute-marne")}
				...
				<path data-name="Meurthe-et-Moselle" data-departmentnumber="54"
					  onClick={() => props.onDepartmentClick(54)}
					  className={computeMapItemClass(props.game,54,"region-44 department department-54 department-meurthe-et-moselle")}
				...
				<path data-name="Meuse" data-departmentnumber="55"
					  onClick={() => props.onDepartmentClick(55)}
					  className={computeMapItemClass(props.game,55,"region-44 department department-55 department-meuse")}
				...
				<path data-name="Moselle" data-departmentnumber="57"
					  onClick={() => props.onDepartmentClick(57)}
					  className={computeMapItemClass(props.game,57,"region-44 department department-57 department-moselle")}
				...
				<path data-name="Bas-Rhin" data-departmentnumber="67"
					  onClick={() => props.onDepartmentClick(67)}
					  className={computeMapItemClass(props.game,67,"region-44 department department-67 department-bas-rhin")}
				...
				<path data-name="Haut-Rhin" data-departmentnumber="68"
					  onClick={() => props.onDepartmentClick(68)}
					  className={computeMapItemClass(props.game,68,"region-44 department department-68 department-haut-rhin")}
				...
				<path data-name="Vosges" data-departmentnumber="88"
					  onClick={() => props.onDepartmentClick(88)}
					  className={computeMapItemClass(props.game,88,"region-44 department department-88 department-vosges")}
			...
			<g className="region region-52" data-name="Pays de la Loire" data-insee="52">
				<path data-name="Loire-Atlantique" data-departmentnumber="44"
					  onClick={() => props.onDepartmentClick(44)}
					  className={computeMapItemClass(props.game,44,"region-52 department department-44 department-loire-atlantique")}
				...
				<path data-name="Maine-et-Loire" data-departmentnumber="49"
					  onClick={() => props.onDepartmentClick(49)}
					  className={computeMapItemClass(props.game,49,"region-52 department department-49 department-maine-et-loire")}
				...
				<path data-name="Mayenne" data-departmentnumber="53"
					  onClick={() => props.onDepartmentClick(53)}
					  className={computeMapItemClass(props.game,53,"region-52 department department-53 department-mayenne")}
				...
				<path data-name="Sarthe" data-departmentnumber="72"
					  onClick={() => props.onDepartmentClick(72)}
					  className={computeMapItemClass(props.game,72,"region-52 department department-72 department-sarthe")}
				...
				<path data-name="Vendée" data-departmentnumber="85"
					  onClick={() => props.onDepartmentClick(85)}
					  className={computeMapItemClass(props.game,85,"region-52 department department-85 department-vendee")}
			...
			<g className="region region-53" data-name="Bretagne" data-insee="53">
				<path data-name="Côtes-d’Armor" data-departmentnumber="22"
					  onClick={() => props.onDepartmentClick(22)}
					  className={computeMapItemClass(props.game,22,"region-53 department department-22 department-cotes-darmor")}
				...
				<path data-name="Finistère" data-departmentnumber="29"
					  onClick={() => props.onDepartmentClick(29)}
					  className={computeMapItemClass(props.game,29,"region-53 department department-29 department-finistere")}
				...
				<path data-name="Ille-et-Vilaine" data-departmentnumber="35"
					  onClick={() => props.onDepartmentClick(35)}
					  className={computeMapItemClass(props.game,35,"region-53 department department-35 department-ille-et-vilaine")}
				...
				<path data-name="Morbihan" data-departmentnumber="56"
					  onClick={() => props.onDepartmentClick(56)}
					  className={computeMapItemClass(props.game,56,"region-53 department department-56 department-morbihan")}
			...
			<g className="region region-75" data-name="Nouvelle-Aquitaine" data-insee="75">
				<path data-name="Charente" data-departmentnumber="16"
					  onClick={() => props.onDepartmentClick(16)}
					  className={computeMapItemClass(props.game,16,"region-75 department department-16 department-charente")}
				...
				<path data-name="Charente-Maritime" data-departmentnumber="17"
					  onClick={() => props.onDepartmentClick(17)}
					  className={computeMapItemClass(props.game,17,"region-75 department department-17 department-charente-maritime")}
				...
				<path data-name="Corrèze" data-departmentnumber="19"
					  onClick={() => props.onDepartmentClick(19)}
					  className={computeMapItemClass(props.game,19,"region-75 department department-19 department-correze")}
				...
				<path data-name="Creuse" data-departmentnumber="23"
					  onClick={() => props.onDepartmentClick(23)}
					  className={computeMapItemClass(props.game,23,"region-75 department department-23 department-creuse")}
				...
				<path data-name="Dordogne" data-departmentnumber="24"
					  onClick={() => props.onDepartmentClick(24)}
					  className={computeMapItemClass(props.game,24,"region-75 department department-24 department-dordogne")}
				...
				<path data-name="Gironde" data-departmentnumber="33"
					  onClick={() => props.onDepartmentClick(33)}
					  className={computeMapItemClass(props.game,33,"region-75 department department-33 department-gironde")}
				...
				<path data-name="Landes" data-departmentnumber="40"
					  onClick={() => props.onDepartmentClick(40)}
					  className={computeMapItemClass(props.game,40,"region-75 department department-40 department-landes")}
				...
				<path data-name="Lot-et-Garonne" data-departmentnumber="47"
					  onClick={() => props.onDepartmentClick(47)}
					  className={computeMapItemClass(props.game,47,"region-75 department department-47 department-lot-et-garonne")}
				...
				<path data-name="Pyrénées-Atlantiques" data-departmentnumber="64"
					  onClick={() => props.onDepartmentClick(64)}
					  className={computeMapItemClass(props.game,64,"region-75 department department-64 department-pyrenees-atlantiques")}
				...
				<path data-name="Deux-Sèvres" data-departmentnumber="79"
					  onClick={() => props.onDepartmentClick(79)}
					  className={computeMapItemClass(props.game,79,"region-75 department department-79 department-deux-sevres")}
				...
				<path data-name="Vienne" data-departmentnumber="86"
					  onClick={() => props.onDepartmentClick(86)}
					  className={computeMapItemClass(props.game,86,"region-75 department department-86 department-vienne")}
				...
				<path data-name="Haute-Vienne" data-departmentnumber="87"
					  onClick={() => props.onDepartmentClick(87)}
					  className={computeMapItemClass(props.game,87,"region-75 department department-87 department-haute-vienne")}
			...
			<g className="region region-76" data-name="Occitanie" data-insee="76">
				<path data-name="Ariège" data-departmentnumber="09"
					  onClick={() => props.onDepartmentClick(9)}
					  className={computeMapItemClass(props.game,9,"region-76 department department-09 department-ariege")}
				...
				<path data-name="Aude" data-departmentnumber="11"
					  onClick={() => props.onDepartmentClick(11)}
					  className={computeMapItemClass(props.game,11,"region-76 department department-11 department-aude")}
				...
				<path data-name="Aveyron" data-departmentnumber="12"
					  onClick={() => props.onDepartmentClick(12)}
					  className={computeMapItemClass(props.game,12,"region-76 department department-12 department-aveyron")}
				...
				<path data-name="Gard" data-departmentnumber="30"
					  onClick={() => props.onDepartmentClick(30)}
					  className={computeMapItemClass(props.game,30,"region-76 department department-30 department-gard")}
				...
				<path data-name="Haute-Garonne" data-departmentnumber="31"
					  onClick={() => props.onDepartmentClick(31)}
					  className={computeMapItemClass(props.game,31,"region-76 department department-31 department-haute-garonne")}
				...
				<path data-name="Gers" data-departmentnumber="32"
					  onClick={() => props.onDepartmentClick(32)}
					  className={computeMapItemClass(props.game,32,"region-76 department department-32 department-gers")}
				...
				<path data-name="Hérault" data-departmentnumber="34"
					  onClick={() => props.onDepartmentClick(34)}
					  className={computeMapItemClass(props.game,34,"region-76 department department-34 department-herault")}
				...
				<path data-name="Lot" data-departmentnumber="46"
					  onClick={() => props.onDepartmentClick(46)}
					  className={computeMapItemClass(props.game,46,"region-76 department department-46 department-lot")}
				...
				<path data-name="Lozère" data-departmentnumber="48"
					  onClick={() => props.onDepartmentClick(48)}
					  className={computeMapItemClass(props.game,48,"region-76 department department-48 department-lozere")}
				...
				<path data-name="Hautes-Pyrénées" data-departmentnumber="65"
					  onClick={() => props.onDepartmentClick(65)}
					  className={computeMapItemClass(props.game,65,"region-76 department department-65 department-hautes-pyrenees")}
				...
				<path data-name="Pyrénées-Orientales" data-departmentnumber="66"
					  onClick={() => props.onDepartmentClick(66)}
					  className={computeMapItemClass(props.game,66,"region-76 department department-66 department-pyrenees-orientales")}
				...
				<path data-name="Tarn" data-departmentnumber="81"
					  onClick={() => props.onDepartmentClick(81)}
					  className={computeMapItemClass(props.game,81,"region-76 department department-81 department-tarn")}
				...
				<path data-name="Tarn-et-Garonne" data-departmentnumber="82"
					  onClick={() => props.onDepartmentClick(82)}
					  className={computeMapItemClass(props.game,82,"region-76 department department-82 department-tarn-et-garonne")}
			...
			<g className="region region-84" data-name="Auvergne-Rhône-Alpes" data-insee="84">
				<path data-name="Ain" data-departmentnumber="01"
					  onClick={() => props.onDepartmentClick(1)}
					  className={computeMapItemClass(props.game,1,"region-84 department department-01 department-ain")}
				...
				<path data-name="Allier" data-departmentnumber="03"
					  onClick={() => props.onDepartmentClick(3)}
					  className={computeMapItemClass(props.game,3,"region-84 department department-03 department-allier")}
				...
				<path data-name="Ardèche" data-departmentnumber="07"
					  onClick={() => props.onDepartmentClick(7)}
					  className={computeMapItemClass(props.game,7,"region-84 department department-07 department-ardeche")}
				...
				<path data-name="Cantal" data-departmentnumber="15"
					  onClick={() => props.onDepartmentClick(15)}
					  className={computeMapItemClass(props.game,15,"region-84 department department-15 department-cantal")}
				...
				<path data-name="Drôme" data-departmentnumber="26"
					  onClick={() => props.onDepartmentClick(26)}
					  className={computeMapItemClass(props.game,26,"region-84 department department-26 department-drome")}
				...
				<path data-name="Isère" data-departmentnumber="38"
					  onClick={() => props.onDepartmentClick(38)}
					  className={computeMapItemClass(props.game,38,"region-84 department department-38 department-isere")}
				...
				<path data-name="Loire" data-departmentnumber="42"
					  onClick={() => props.onDepartmentClick(42)}
					  className={computeMapItemClass(props.game,42,"region-84 department department-42 department-loire")}
				...
				<path data-name="Haute-Loire" data-departmentnumber="43"
					  onClick={() => props.onDepartmentClick(43)}
					  className={computeMapItemClass(props.game,43,"region-84 department department-43 department-haute-loire")}
				...
				<path data-name="Puy-de-Dôme" data-departmentnumber="63"
					  onClick={() => props.onDepartmentClick(63)}
					  className={computeMapItemClass(props.game,63,"region-84 department department-63 department-puy-de-dome")}
				...
				<path data-name="Rhône" data-departmentnumber="69"
					  onClick={() => props.onDepartmentClick(69)}
					  className={computeMapItemClass(props.game,69,"region-84 department department-69 department-rhone")}
				...
				<path data-name="Savoie" data-departmentnumber="73"
					  onClick={() => props.onDepartmentClick(73)}
					  className={computeMapItemClass(props.game,73,"region-84 department department-73 department-savoie")}
				...
				<path data-name="Haute-Savoie" data-departmentnumber="74"
					  onClick={() => props.onDepartmentClick(74)}
					  className={computeMapItemClass(props.game,74,"region-84 department department-74 department-haute-savoie")}
			...
			<g className="region region-93" data-name="Provence-Alpes-Côte d&#39;Azur" data-insee="93">
				<path data-name="Alpes-de-Haute-Provence" data-departmentnumber="04"
					  onClick={() => props.onDepartmentClick(4)}
					  className={computeMapItemClass(props.game, 4, "region-93 department department-04 department-alpes-de-haute-provence")}
				...
				<path data-name="Hautes-Alpes" data-departmentnumber="05"
					  onClick={() => props.onDepartmentClick(5)}
					  className={computeMapItemClass(props.game, 5, "region-93 department department-05 department-hautes-alpes")}
				...
				<path data-name="Alpes-Maritimes" data-departmentnumber="06"
					  onClick={() => props.onDepartmentClick(6)}
					  className={computeMapItemClass(props.game, 6, "region-93 department department-06 department-alpes-maritimes")}
				...
				<path data-name="Bouches-du-Rhône" data-departmentnumber="13"
					  onClick={() => props.onDepartmentClick(13)}
					  className={computeMapItemClass(props.game, 13, "region-93 department department-13 department-bouches-du-rhone")}
				...
				<path data-name="Var" data-departmentnumber="83"
					  onClick={() => props.onDepartmentClick(83)}
					  className={computeMapItemClass(props.game, 83, "region-93 department department-83 department-var")}
				...
				<path data-name="Vaucluse" data-departmentnumber="84"
					  onClick={() => props.onDepartmentClick(84)}
					  className={computeMapItemClass(props.game, 84, "region-93 department department-84 department-vaucluse")}
			...
			<g className="region region-94" data-name="Corse" data-insee="94">
				<path data-name="Corse-du-Sud" data-departmentnumber="2A"
					  onClick={() => props.onDepartmentClick("2A")}
					  className={computeMapItemClass(props.game, "2A", "region-94 department department-2A department-corse-du-sud")}
				...
				<path data-name="Haute-Corse" data-departmentnumber="2B"
					  onClick={() => props.onDepartmentClick("2B")}
					  className={computeMapItemClass(props.game, "2B", "region-94 department department-2B department-haute-corse")}
